...
type
  ...
  T7zCompressionMethod = (m7Copy, m7LZMA, m7LZMA2, m7BZip2, m7PPMd, m7Deflate, m7Deflate64);
                                                                                              //  ZIP 7z GZIP BZ2
...
const
  ...
  SevCompressionMethod: array[T7zCompressionMethod]  of UnicodeString = ('COPY', 'LZMA', 'LZMA2', 'BZIP2', 'PPMD', 'DEFLATE', 'DEFLATE64');
